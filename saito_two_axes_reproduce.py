...
Reproduction script for
    ...
    "Catatonia recovers along two separable intervention axes that constrain
...
MANUSCRIPT_TITLE = 'Catatonia recovers along two separable intervention axes that constrain electroconvulsive therapy'
...
SUPPLEMENT_PARAS = [
 ...
 ('blank', ''),
 ('p', '**Catatonia recovers along two separable intervention axes that constrain electroconvulsive therapy**'),
 ('p', 'Hiroki Saito'),
 ('blank', ''),
